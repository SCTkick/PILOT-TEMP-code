...
<div class="wrapper">
	<div class="sidebar" data-color="white" data-active-color="warning">
		...
		<div class="sidebar-wrapper ps-container ps-theme-default ps-active-x" data-ps-id="37ee20ba-e378-3a79-bc57-88347af65756">
			<ul class="nav">
				<li><a href="" class="text-danger"><i class="nc-icon nc-bank text-danger"></i><p>Halaman Utama</p></a></li>
				...
				<div class="card card-plain">
					...
					<div class="card">
						...
						<div class="card-body col-md-11" style="padding-left: 12pt">
							<p>Pilih tab di samping untuk mengakses layanan yang tersedia. Perlu diketahui beberapa layanan yang ada masih dalam tahap pengembangan, sehingga kesalahan bisa saja terjadi.</p>
						</div>
